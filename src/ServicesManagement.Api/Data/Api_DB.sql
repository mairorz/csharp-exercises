...
create table users (
  ...
  role enum('admin', 'owner', 'support') default 'owner',
...
-- Usuarios
insert into users (username, name, surname, password_hash, phone, email, role, created_at, updated_at) values
('juanp', 'juan', 'perez', 'hash1', '5551-0001', 'juan@empresa.com', 'owner', '2025-09-04 10:00:00', '2025-09-04 10:00:00'),
('marial', 'maria', 'lopez', 'hash2', '5552-0002', 'maria@empresa.com', 'support', '2025-09-04 10:05:00', '2025-09-04 10:05:00'),
('carlosg', 'carlos', 'gomez', 'hash3', '5553-0003', 'carlos@empresa.com', 'owner', '2025-09-04 10:10:00', '2025-09-04 10:10:00'),
('anar', 'ana', 'ruiz', 'hash4', '5554-0004', 'ana@empresa.com', 'owner', '2025-09-04 10:15:00', '2025-09-04 10:15:00'),
('luist', 'luis', 'torres', 'hash5', '5555-0005', 'luis@empresa.com', 'support', '2025-09-04 10:20:00', '2025-09-04 10:20:00');
